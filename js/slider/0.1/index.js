...
define([
  ...
  function (
    ...
    slidehtml, 
    slidecss, 
    emitter) {//Do not add angular services as an argument
  'use strict';

  app.registerDirective('slider', [
  '$timeout', 
  'eventService', 
  'timerService', 
  '$q', 
      ...
      compile: function () {
        return {
          post: function (scope, element, attrs, ctrl) {
             ...
             */
            ctrl.getData(scope, ctrl.storageID, function gettingData(data) {
              var idx = 0;
              var defer = $q.defer();
              ...
              function timerSet() {
                ...
                timerService.init({
                  interval: ctrl.slideTime,
                  eventToEmit: 'next',
                  callback: ctrl.slideRight,
                  targetElement: rightCtrl,
              ...
              function initListeners() {
                $timeout(function () {
                  ...
                  eventService.on('prev', function previousSlide() {
                    timerSet();
                    idx !== 0 ? idx-=1 : 0;
                  ...
                  eventService.on('next', function nextSlide() {
  ...
  function ($scope, $compile, $element, eventService, sliderService) {
    ...
    _this.slideLeft = function () {
      eventService.emit('prev');
    };
    _this.slideRight = function () {
      eventService.emit('next');
    };
  }]);
});
